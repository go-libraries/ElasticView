  ...
  <div class="app-container">
    <el-card class="box-card">
      <div class="filter-container">
        ...
        <el-button type="success" class="filter-item" icon="el-icon-sort" :loading="readOnlyAllowDeleteLoading"
      ...
      >
        ...
        <el-table-column align="center" label="索引的开启状态" width="100">
          <template slot-scope="scope">
            <el-button v-show="scope.row.status == 'open'" type="success" size="small" @click="OpenOrCloseIndex(scope.row.index,'close',1)" icon="el-icon-success">开启
            </el-button>
            <el-button v-show="scope.row.status == 'close'" type="danger" size="small" @click="OpenOrCloseIndex(scope.row.index,'open',1)" icon="el-icon-circle-close">关闭
            </el-button>
          </template>
        </el-table-column>
      ...
      >
        ...
        <el-tabs v-model="activeName" style="margin-left: 10px" @tab-click="changeTab">
          ...
          <el-tab-pane label="编辑索引配置" name="editSettings">
            <el-form>
              <el-form-item label="编辑索引配置" prop="pass">
                <el-form-item>
                  <el-button type="primary" icon="el-icon-edit-outline" @click="submitSettings()">提交</el-button>
                  <el-button @click="resetSettings" icon="refresh">重置</el-button>
                </el-form-item>
                <json-editor
                  :point-out="pointOut"
                  v-loading="tabLoading"
          ...
          <div class="filter-container">
            ...
            <el-button type="danger"
                       ...
                       size="small"
                       icon="el-icon-circle-close" class="filter-item" @click="OpenOrCloseIndex(indexName,'close',0)">关闭
            </el-button>

            <el-button type="success"
                       :loading="loadingGroup[1]"
                       size="small"
                       icon="el-icon-success" class="filter-item"
                       @click="OpenOrCloseIndex(indexName,'open',1)">打开
            </el-button>
            <el-button size="small" icon="el-icon-connection" class="filter-item"
                       @click="runCommand('/_forcemerge?max_num_segments=1',2)" :loading="loadingGroup[2]">强制合并索引
            </el-button>
            ...
            <el-popover
              ...
              <el-button class="filter-item" slot="reference" size="small" :loading="loadingGroup[3]" type="primary"
                         icon="el-icon-refresh"
                         @click="runCommand('/_refresh',3)">刷新索引
              </el-button>
            </el-popover>
            ...
            <el-popover
              ...
              <el-button slot="reference" size="small" :loading="loadingGroup[4]" type="info" icon="el-icon-s-open"
                         @click="runCommand('/_flush',4)" class="filter-item">冲洗索引
              </el-button>
            </el-popover>

            <el-button class="filter-item" size="small" type="warning" :loading="loadingGroup[5]"
                       icon="el-icon-toilet-paper"
                       @click="runCommand('/_cache/clear',5)">清理缓存
            </el-button>


            <el-button class="filter-item" type="danger" size="small" :loading="loadingGroup[6]" icon="el-icon-delete"
                       @click="deleteIndex(indexName,6)">删除索引
            </el-button>
