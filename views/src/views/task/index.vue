  ...
  <div class="app-container">
    <el-card class="box-card">
      ...
      >
        ...
        <el-table-column align="center" label="运行时间" prop="running_time" width="100" />
        <el-table-column align="center" label="运行时间（毫微秒）" prop="running_time_in_nanos" width="100" />
...
import { ListAction, CancelAction } from '@/api/es-task'
