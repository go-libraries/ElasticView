  ...
  <div class="app-container">
    <el-card class="box-card">
      <div class="filter-container">
        <el-select v-model="snapshotNameList" clearable filterable multiple placeholder="请选择仓库名" :loading="loading"
                   @change="search">
          <el-option
        ...
        <el-button @click.native="openAddDialog = true" type="warning">新建仓库</el-button>
      </div>
      <el-table
        :data="tableData"
      >
        ...
        <el-table-column align="center" label="操作" fixed="right" width="300">
          <template slot-scope="scope">
            <el-button-group>
              ...
              <el-button type="warning" size="small" icon="el-icon-edit" @click="updateSnapshotData(scope.row)">修改</el-button>
              <el-button type="danger" size="small" icon="el-icon-delete" @click="SnapshotDeleteRepositoryAction(scope.row.name)">删除</el-button>
            </el-button-group>
    ...
    <add :snapshotData="snapshotData" :open="openAddDialog" v-if="openAddDialog"
         @close="closeAddDialog"></add>
  </div>
</template>

<script>
    import {SnapshotListAction,SnapshotDeleteRepositoryAction} from '@/api/es-backup'
