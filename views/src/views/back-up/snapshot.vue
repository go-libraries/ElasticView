<template>
  <div class="app-container">
      ...
      >
        ...
        <el-table-column align="center" label="状态" width="100">
          <template slot-scope="scope">
            ...
            <el-tag type="warning" v-else-if="scope.row.status == 'IN_PROGRESS'">还在进行中</el-tag>
    ...
    />
    <snapshot-restore :repository="repositoryName"  :snapshot="name" v-if="openRestoreDialog"
