<template>
  <div :style="styles" class="float">
    <span style="text-align: center;display:block;" class="font1">
      {{ title }}
      <el-button icon="el-icon-refresh" @click="format">Format</el-button>
      <el-button v-clipboard:copy="value" v-clipboard:success="onCopy" v-clipboard:error="onError"
                 icon="el-icon-document-copy">点击复制</el-button>
    </span>
    <editor
      v-model="value"
      lang="json"
